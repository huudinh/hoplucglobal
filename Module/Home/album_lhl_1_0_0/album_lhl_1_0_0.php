<?php   
    include(locate_template("Module/Post/album_lhl_1_0_0/album_lhl_1_0_0_css.php"));     
?>      
<style>
    @font-face {
    ...
    <div class="container">
        <div class="album_lhl_1_0_0__box">
            <div class="album_lhl_1_0_0__title">
                ...
                <i class="album_lhl_1_0_0__icon"></i>
            </div>
            <div class="album_lhl_1_0_0__des">
                <?php 
                    while ( have_posts() ) : 
                        the_post(); 
                        the_content();  
            ...
            <div class="album_lhl_1_0_0__photo" id="album_lhl_1_0_0__photo"></div>
...
<script>
    ...
    function renderPhoto(data){
        for(let i = 0; i < 5; i++){
            document.getElementById('album_lhl_1_0_0__photo').insertAdjacentHTML('beforeend', photoCard(data[i], i))     
        }
    }
