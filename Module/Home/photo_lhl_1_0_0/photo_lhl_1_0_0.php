<?php
    if($check == 0){
        include(locate_template("Module/Home/photo_lhl_1_0_0/photo_lhl_1_0_0_css.php")); 
    }
?>  
<section id="photo_lhl_1_0_0__root"></section>
<?php 
    include(locate_template('Module/api_photo.php')); 
?>
<script>
    const photo_lhl_1_0_0_url = '<?php echo $path ?>';
    photo_lhl_1_0_0_menu = dataPhoto;

let photo_lhl_1_0_0_title = '' //Tiêu đề menu
let photo_lhl_1_0_0_indexViewMore = 4 // số hình ảnh được hiện
...
const photo_lhl_1_0_0_handleChangeTab = (name, link) => {
    ...
    photo_lhl_1_0_0_indexViewMore = 4
...
const photo_lhl_1_0_0_MenuItem = (item, active) => {
    return `<li onclick="photo_lhl_1_0_0_handleChangeTab('${item.name}','${item.link}')" class="${active?'active':''}"><h2 class="sidebar_da_1_1_0__titleTab"><a href="${item.link}" >${item.name}</a></h2></li>`
}
...
const photo_lhl_1_0_0_main = (data) => {
            ...
            <div class="photo_1_1_0">
                <div class="photo_1_1_0__sidebar">
                    <div class="sidebar_da_1_1_0">
                        <div class="sidebar_da_1_1_0__title">
                            <h2 class="sidebar_da_1_1_0__titleHead">${photo_lhl_1_0_0_title}</h2>
                ...
                <div class="photo_1_1_0__content">
                    <div class="photo_lhl_1_0_0">
                        ...
                        <h1 class="photo_lhl_1_0_0__title">Hình ảnh trước - sau</h1>
    ...
    photo_lhl_1_0_0_menu.forEach(item=>{
        if( window.location.hash===item.link) {
            photo_lhl_1_0_0_handleChangeTab(item.name,item.link)
        };
    })
