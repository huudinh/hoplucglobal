<?php
	include(locate_template("Module/Category/clientsCate_lhl_1_0_0/clientsCate_lhl_1_0_0_css.php"));
?>
<div class="clientsCate_lhl_1_0_0">
    <div class="clientsCate_lhl_1_0_0__title">PROJECTS</div>
    <div class="clientsCate_lhl_1_0_0__line"></div>
    <ul>
		<?php 
			if ( have_posts() ) :
