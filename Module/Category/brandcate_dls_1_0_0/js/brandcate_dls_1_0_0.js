...
const brandCard = (data) => {
    let name = data.name;
    (name == 'Tiling') ? name = 'Lighting' : name;
    (name == 'Door') ? name = 'Finish & Technic' : name;
...
const brandNav = (name, link, index) => {
    ...
    let nameView = name;
    (nameView == 'Tiling') ? nameView = 'Lighting' : nameView;
    (nameView == 'Door') ? nameView = 'Finish & Technic' : nameView;
